...
> 文档版本：V0.1  
> 更新日期：2026-09-24
> 当前状态：核心业务已实现；最新修复、全链路回归与发布见 DAILY_USE_FIXES_2026-09-24.md
...
- 按 D-010/D-033，当前固定场景为面试、转正、晋升，对应 `INTERVIEW`、`REGULARIZATION`、`PROMOTION`。
...
- [2026-09-24 日常使用验收](./DAILY_USE_ACCEPTANCE_2026-09-24.md)：执行范围、用例结果、修复、容量数据及仍待验证事项。
- [可重复运行的测试入口](../scripts/qa/README.md)：隔离环境、真实 API/浏览器及自动清理。

- [日常使用问题修复与回归](./DAILY_USE_FIXES_2026-09-24.md)：类型门禁、密码流程、加密导入清单恢复及 V025。
